...
public class AdBlock {
    ...
    Context c;
    // Synchronized so the background file-loading thread and the WebView
    // network thread can never race on the same HashSet at once.
    private final Set<String> mBlockedDomainsList = Collections.synchronizedSet(new HashSet<String>());
