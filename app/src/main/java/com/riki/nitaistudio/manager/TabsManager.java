package com.riki.nitaistudio.manager;
...
public class TabsManager {
    ...
    public synchronized BrowserView newTab(@NonNull Activity activity, @Nullable String str) {
        return newTab(activity, str, false);
    }

    @NonNull
    public synchronized BrowserView newTab(@NonNull Activity activity, @Nullable String str, boolean incognito) {
        BrowserView browserView;
        browserView = new BrowserView(activity, str, incognito);
