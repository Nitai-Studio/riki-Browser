...
public class NewDownloadActivity extends BaseActivity {
    ...
    public static final String DOWNLOAD_FILE_NAME = "com.riki.nitaistudio.filename";
    public static final String DOWNLOAD_PATH = "com.riki.nitaistudio.parts";
    public static final String DOWNLOAD_URL = "com.riki.nitaistudio.url";
