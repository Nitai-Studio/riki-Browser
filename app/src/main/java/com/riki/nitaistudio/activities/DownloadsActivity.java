...
import com.riki.nitaistudio.adapter.CompletedAdapter;
import com.riki.nitaistudio.adapter.DownloadingAdapter;
import com.riki.nitaistudio.adapter.DownloadsPagerAdapter;
import com.riki.nitaistudio.database.DataUpdatedEvent;
import com.riki.nitaistudio.services.DownloadsService;
import com.riki.nitaistudio.utils.FileUtils;
import com.riki.nitaistudio.view.AdvancedAppCompatEditText;
import com.riki.nitaistudio.view.MaterialSearchView;
...
public class DownloadsActivity extends BaseActivity implements CompletedAdapter.OnCompletedDownloadClickedListener, DownloadingAdapter.OnRetryDownloadClickedListener, DownloadingAdapter.OnResumeDownloadClickedListener, DownloadingAdapter.OnPauseDownloadClickedListener, DownloadingAdapter.OnRemoveDownloadsListener, DownloadingAdapter.OnUrlChangedListener {
    ...
    public static final String SELECTED_TAB = "com.riki.nitaistudio.SELECTED";
